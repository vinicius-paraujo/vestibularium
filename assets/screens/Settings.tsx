...
export default function Settings() {
    ...
    const [userData, setUserData] = useState({username: null, type: null, email: null});
    ...
    const getPermissionAsync = async () => {
        ...
        if (status !== 'granted') {
            setAlert(true);
            setErrMessage('É necessário conceder permissão para acessar a galeria de imagens');
        }
        }
    };
    ...
    if (userData) {
        return(
            ...
            <AwesomeAlert
                cancelButtonStyle={{backgroundColor: theme.mainCol}}
                confirmButtonStyle={{backgroundColor: theme.mainCol}}
                cancelButtonTextStyle={{color: theme.backgroundColor, fontFamily: "MADETOMMY", fontSize: 14, paddingHorizontal: 15, paddingVertical: 5}}
                confirmButtonTextStyle={{color: theme.backgroundColor, fontFamily: "MADETOMMY", fontSize: 14, paddingHorizontal: 15, paddingVertical: 5}}
                showCancelButton={true}
                onCancelPressed={() => {setDeleteAlert(false)}}
                cancelText='Não!'
                ...
                contentContainerStyle={{borderRadius: 15, backgroundColor: theme.backgroundColor}}
                titleStyle={{color: theme.light, fontFamily: "MADETOMMY", alignSelf: "center", justifyContent: "center", textAlign: "center", fontSize: 16}}
                title={"Você realmente deseja apagar sua conta? Essa ação é IRREVERSÍVEL!"} 
            />
            ...
            <ScrollView>
                <View style={{
                    ...
                    <View style={{
                        ...
                        <Text style={[styles.text, { color: theme.light, fontSize: 10 }]}><Text style={{color: theme.mainCol }}>Observação</Text>: o nome de usuário deve ter no mínimo 3 letras. Evite o uso de espaços e caracteres especiais.</Text>
                ...
                <View style={{justifyContent: 'flex-end', marginTop: 150}}>
                        <TouchableOpacity onPress={() => {
                            ...
                            <Ionicons name="remove-circle" size={20} color={theme.mainCol} style={{marginRight: 5, alignSelf: 'center'}} />
                        </TouchableOpacity>
                </View>
            </ScrollView>
            </SafeAreaView>
