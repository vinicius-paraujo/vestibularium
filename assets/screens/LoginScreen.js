...
export default function LoginScreen({navigation}) {
    ...
    const getUserInfo = async () => {
        try {
          ...
          if (userD) googleLogin(userD, response.authentication.accessToken);
        } catch (error) {
            setAuthenticated(false);
            console.log(error);
        }
    ...
    return(
        <SafeAreaView onLayout={onLayoutRootView} style={styles.mainContent} >
            ...
            <View style={{
                ...
                <Ionicons name="logo-twitter" size={20} color="#1DA1F2" style={{alignSelf: "center", alignSelf: "center"}} />
                </TouchableOpacity>
                ...
                <Ionicons name="logo-facebook" size={20} color="#4267B2" style={{alignSelf: "center"}} />
                </TouchableOpacity>
            </View>
